  ...
  return (
    <div>
      ...
      <div className="flex mt-20  flex-col flex-wrap justify-center xl:flex-row gap-4 ">
        <div className="flex text-xl flex-col  flex-shrink-0  flex-1 items-start py-12 mx-10 px-16 border-2 text-sm  hover:bg-primary hover:text-white transition-all duration-500">
        ...
        <div className="flex text-xl flex-col transition-all duration-500 flex-1 items-start py-12 mx-10 px-16 border-2 text-sm  hover:bg-primary hover:text-white">
          <p className="font-bold">Effciency:</p>
          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam
            est, a quidem sequi numquam animi eligendi consequatur mollitia sed.
