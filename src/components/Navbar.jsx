...
function Navbar() {
  ...
  return (
    <div className="flex items-center justify-between py-4 mb-5  shadow-md">
      <p
      ...
      <div className="flex items-center justify-center gap-4">
        {token ? (
          <div className="flex items-center gap-2 cursor-pointer group relative ">
            ...
            <div className="absolute top-0  pt-14 text-base font-medium text-gray-600 hidden group-hover:block ">
              <div className="min-w-32 flex flex-col rounded gap-4 p-4 shadow-lg hover:cursor-pointer ">
                <p
